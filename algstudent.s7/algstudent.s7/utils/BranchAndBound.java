...
public class BranchAndBound {
	...
	public void branchAndBound(Node rootNode) { 
		...
		while (!ds.empty() && ds.estimateBest() < pruneLimit) {
			...
			{
				child.calculateHeuristicValue();//STUDENT: this line is used to update the new heuristic of the children
			
				if (child.isSolution()) {
					
					
					int cost = child.getHeuristicValue(); 
					System.out.println("This is a valid solution: " + child.toString()); //STUDENT: output related messages.
