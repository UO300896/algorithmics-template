...
public class PyramidPuzzleTest {
	@Test
	public void test5() {
		boolean result = executeFromFile("C:\\Algoritmia\\Lab\\algorithmics-template\\algstudent.s7\\ws2\\Lab7\\src\\case5.txt");
		assertEquals(true, result);
	}
	
	@Test
	public void test15() {
		boolean result = executeFromFile("C:\\Algoritmia\\Lab\\algorithmics-template\\algstudent.s7\\ws2\\Lab7\\src\\case15.txt");
		assertEquals(true, result);
	}
